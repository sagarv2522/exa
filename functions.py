...
def load_dataset():
    ...
    train_dataset = h5py.File('"D:\Downloads\Streamlit\Datasets\train_catvnoncat.h5"', "r") #change the file path accordingly
    train_set_x_orig = np.array(train_dataset["train_set_x"][:]) 
    train_set_y_orig = np.array(train_dataset["train_set_y"][:])

    #load the test dataset as h5 file
    test_dataset = h5py.File('"D:\Downloads\Streamlit\Datasets\test_catvnoncat.h5"', "r")
